package org.onlydevs.registration.endpoint.event.model;

import static java.lang.Math.random;
import static org.onlydevs.registration.endpoint.event.EventStack.EVENT_STACK_1;
...
import org.onlydevs.registration.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    return "org.onlydevs.registration.event1";
  }
}
