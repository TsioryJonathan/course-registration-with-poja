package org.onlydevs.registration.endpoint.event.consumer;
...
import org.onlydevs.registration.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("org.onlydevs.registration.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "org.onlydevs.registration.service.event."
